...
#   DEVICE_CLAIM_ENABLED   → true/false; enables shared Redis device limits
#   DEVICE_CLAIM_TYPE      → redis (default)
#   DEVICE_CLAIM_ADDR      → Redis host:port
#   DEVICE_CLAIM_PASSWORD  → Redis password
#   DEVICE_CLAIM_DB        → Redis database number
#   DEVICE_CLAIM_PREFIX    → Redis key prefix
#   DEVICE_CLAIM_TTL       → claim TTL in seconds (default 300)
