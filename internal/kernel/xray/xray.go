...
// SetDeviceClaimStore is a no-op for xray — this path does not currently
// expose pre-forward connection admission hooks in this wrapper.
func (x *Xray) SetDeviceClaimStore(_ kernel.DeviceClaimStore) {}
